<template lang='pug'>
v-app-bar.nav-header(color='#38B000', dark, app, :clipped-left='!$vuetify.rtl', :clipped-right='$vuetify.rtl', fixed, flat, :extended='searchIsShown && $vuetify.breakpoint.smAndDown')
    ...
    v-layout(row)
      v-flex(xs5, md4)
        v-toolbar.nav-header-inner(color='#38B000')
          ...
          v-toolbar-title(:class='{ "mx-3": $vuetify.breakpoint.mdAndUp, "mx-1": $vuetify.breakpoint.smAndDown }')
            span.subheading {{'Portal Yacaré'}}
      v-flex(md4, v-if='$vuetify.breakpoint.mdAndUp')
        v-toolbar.nav-header-inner(color='#38B000', dark, flat)
          slot(name='mid')
      ...
      v-flex(xs7, md4)
        v-toolbar.nav-header-inner.pr-4(color='#38B000', dark, flat)
          v-spacer
