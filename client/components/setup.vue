        ...
        v-layout
          v-flex(xs12, lg6, offset-lg3)
            v-card.elevation-20.radius-7.animated.fadeInUp
              ...
              .text-center
                img.setup-logo.animated.fadeInUp.wait-p2s(src='/_assets/img/splash/yaca-hori.png', alt='Yacaré')
              ...
              v-alert(v-if='!error', tile, color='blue lighten-5', :value='true')
                ...
                span.blue--text Estas por ingresar al Portal de Documentación de Yacaré #[strong {{2.1}}].
              v-card-text
