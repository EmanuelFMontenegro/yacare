...
export default {
  ...
  watch: {
    'user.appearance': (newValue, oldValue) => { //eslint-disable-line
      if (newValue === '') {
    ...
    'user.dateFormat': (newValue, oldValue) => { //eslint-disable-line
      if (newValue === '') {
    ...
    'user.timezone': (newValue, oldValue) => {//eslint-disable-line
      if (newValue === '') {
