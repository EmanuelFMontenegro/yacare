<template lang="pug">
  div
    .pa-3.d-flex(v-if='navMode === `MIXED`', :class='$vuetify.theme.dark ? `grey darken-5` : `#38B000`')
      v-btn(
        depressed
        :color='$vuetify.theme.dark ? `grey darken-4` : `#5C5C5C`'
        style='min-width:0;'
        @click='goHome'
      ...
      v-btn.ml-3(
        ...
        depressed
        :color='$vuetify.theme.dark ? `grey darken-4` : `#CCCCCC`'
        style='flex: 1 1 100%;'
